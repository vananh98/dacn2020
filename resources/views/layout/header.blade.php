			...
			<div class="rows">
					...
					<div class="widget text-2 widget_text pull-left">
						<div class="widget-inner">
							<div class="textwidget">
								<div class="call-us"><span>Call Us Now: </span>09-3508-1508</div>
							</div>
						</div>
					</div>
									...
									<ul class="nav">
										<li>
											<a class="lang_sel_sel icl-en">
												<img class="iclflag" title="English" alt="en" src="images/icons/vn2.png" width="18" height="12" /> Việt Nam
											</a>
											<!-- <ul>
														<li class="icl-en">
															<a href="#">
				...
				<div class="wrap-myacc pull-right">
					<div class="sidebar-account pull-left">
								...
								<div class="widget-inner">
									<ul id="menu-my-account" class="menu">
										<li class="menu-my-account">
											<a class="item-link" href="{{route('infor')}}">
										...
										<li>
											<a href="{{Route('getCart')}}" data-toggle="modal">
												<span>Giỏ hàng</span>
											</a>
										</li>
										<li>
											<a href="{{Route('orders')}}" data-toggle="modal">
												<span>Đơn hàng</span>
											</a>
										</li>
										<li>
											<a href="{{Route('clientLogout')}}" data-toggle="modal">
												<span>Thoát</span>
											</a>
										</li>
									</ul>
						...
						<a href="{{Route('login')}}" style="color:white"> {{'Đăng kí'}}</a>
						@endif
								...
								<div class="widget-1 widget-first widget nav_menu-2 widget_nav_menu">
									<div class="widget-inner">
										<ul id="menu-checkout" class="menu">
											<li class="menu-checkout">
												<a class="item-link" href="checkout.html">
													<span class="menu-title">Thoát ra</span>
												</a>
											</li>
										</ul>
									</div>
			...
			<div class="rows">
				...
				<div class="etrostore-logo pull-left">
					<a href="{{route('trangchu')}}">
						<img src="img/slide/logo.png" alt="Shoopy" width="200px" height="10px">
					</a>
				</div>
				<?php
						...
						<div class="widget-inner">
							<div class="top-form top-search">
								<div class="topsearch-entry">
									<form action="{{route('findProduct')}}" method="get" enctype="multipart/form-data">
										@csrf
										<input hidden type="text" name="csrf" value="{{csrf_token()}}">
										<input type="text" value="" name="name" placeholder="Tên sản phẩm....">
										<div class="cat-wrapper">
											<label class="label-search">
												<select name="search_category" class="s1_option">
													<option value="a">Danh mục</option>
						...
						<div class="widget-inner">
							...
							<div class="top-form top-form-minicart etrostore-minicart pull-right">
								<div class="top-minicart-icon pull-right">
									<i id="click123" class="fa fa-shopping-cart"></i>
									<a class="cart-contents" href="{{route('getCart')}}" title="View your shopping cart">
										<!-- Cần hiện số sản phẩm trong giỏ hàng -->
										<span class="minicart-number">
											<!-- đếm hàng trong giỏ hàng -->
											<?php
											...
											if (Auth::check()) {
												...
												$user = Auth::user();
												$cart = orders::where([['FK_MaKH', $user->MaND], ['Trangthai', 'Chưa đặt']])->first();
												if ($cart) {
													$count = order_details::where('FK_MaDH', $cart->MaDH)->count();
													echo $count;
												} else
													echo 0;
											} else
										...
										<ul class="minicart-content">
											<li>
												<a href="simple_product.html" class="product-image">
													<img width="100" height="100" src="images/1903/45-150x150.jpg" class="attachment-100x100 size-100x100 wp-post-image" alt="" srcset="images/1903/45-150x150.jpg 150w, images/1903/45-300x300.jpg 300w, images/1903/45-180x180.jpg 180w, images/1903/45.jpg 600w" sizes="(max-width: 100px) 100vw, 100px" />
												</a>

												<div id="detail-item" class="detail-item">
													<div class="product-details">
														<h4>
															<a id="title-item" class="title-item" href="simple_product.html">Veniam Dolore</a>
														</h4>
											...
											<li>
												<a href="simple_product.html" class="product-image">
													<img width="100" height="100" src="images/1903/22-150x150.jpg" class="attachment-100x100 size-100x100 wp-post-image" alt="" srcset="images/1903/22-150x150.jpg 150w, images/1903/22-300x300.jpg 300w, images/1903/22-180x180.jpg 180w, images/1903/22.jpg 600w" sizes="(max-width: 100px) 100vw, 100px" />
												</a>
	...
	<div class="header-bottom clearfix">
		<div class="container">
			<div class="rows">
						...
						<div class="navbar-inner navbar-inverse">
							...
							<ul id="menu-primary-menu-1" class="nav nav-pills nav-mega etrostore-mega etrostore-menures">
								<li class="active dropdown menu-home etrostore-mega-menu level1">
									<!-- trangchu -->
									<a href="{{route('trangchu')}}" class="item-link dropdown-toggle">
								...
								<li class="dropdown menu-shop etrostore-mega-menu level1 etrostore-menu-img">
									<a href="{{route('productDiscount')}}" class="item-link dropdown-toggle">
										<span class="have-title">
								...
								<li class="dropdown menu-smartphones-tablet etrostore-mega-menu level1">
									<a href="{{route('contact')}}" class="item-link dropdown-toggle">
										<span class="have-title">
								...
								<li class="dropdown menu-blog etrostore-mega-menu level1">
									<a href="{{route('question')}}" class="item-link dropdown-toggle">
										<span class="have-title">
				...
				<!-- /Primary navbar -->
				<!-- cart theo thanh cuộn dọc -->
				<div class="top-form top-form-minicart etrostore-minicart pull-right">
					<div class="top-minicart-icon pull-right">
						<i id="click123b" class="fa fa-shopping-cart"></i>
						<a class="cart-contents" href="{{Route('getCart')}}" title="View your shopping cart">
							<span class="minicart-number">
								<!-- đếm hàng trong giỏ hàng -->
								<?php
								if (Auth::check()) {
									...
									$cart = orders::where([['FK_MaKH', $user->MaND], ['Trangthai', 'Chưa đặt']])->first();
									if ($cart) {
										$count = order_details::where('FK_MaDH', $cart->MaDH)->get()->count();
										echo $count;
									} else
										echo 0;
								} else
