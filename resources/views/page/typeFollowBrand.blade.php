...
<div style="height:40px; background-color:#efefef">
    <h2>{{$brand->TenTH}} : {{$type->TenLoai}}</h2>
</div>
<div class="MeNu" style="height:25px; background-color:#efefef ">
    <ul class="ul">
        @foreach($brand->typeProduct->unique() as $type2)
        <li class="li"><a href="brand{{$brand->MaTH}}/type{{$type2->MaLoai}}">{{$type2->TenLoai}}</a></li>
        @endforeach
    </ul>
</div>
<hr>
            ...
            <div class="item-detail">
                <div class="item-img products-thumb">
                    ...
                    <a href="simple_product/{{$item->MaSP}}">
                        <div class="product-thumb-hover"><img width="300" height="300" src="img/{{$item->Hinh}}" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="" title="{{$item->Hinh}}" sizes="(max-width: 300px) 100vw, 300px"></div>
                    </a>
                ...
                <div class="item-content">
                    ...
                    <h4><a href="simple_product/{{$item->MaSP}}" title="nisi ball tip">{{$item->TenSP}}</a></h4>
