<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{Route('IndexAdmin')}}">
    ...
    <div class="sidebar-brand-text mx-3">Nhân viên giao hàng <sup>2</sup></div>
  </a>
  ...
  <!-- data-toggle="collapse" -->
    <a class="nav-link collapsed" href="staffshipper/editAccount/{{Auth::user()->MaND}}"  data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
      <i class="fas fa-fw fa-folder"></i>
      <span>Cập nhật thông tin cá nhân </span>
    </a>
    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="staffshipper/editAccount/{{Auth::user()->MaND}}">Cập nhật</a>
  ...
  <li class="nav-item">
  <!-- data-toggle="collapse" -->
    <a class="nav-link collapsed" href="{{Route('shiporders')}}"  data-target="#collapsePages2" aria-expanded="true" aria-controls="collapsePages">
      <i class="fas fa-fw fa-folder"></i>
      <span>Cập nhật đơn hàng</span>
    </a>
    <div id="collapsePages2" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="{{Route('shiporders')}}">Danh sách đơn hàng</a>
        <a class="collapse-item" href="{{Route('staffOrderCancel')}}">Đơn hàng trả</a>
      </div>
    </div>
  </li>
  <!-- <li class="nav-item">
